...
All plotting in the course uses base R, so these are the only packages you
need to install. During the session, work in a fresh project (*File → New
Project*) with a new R script and paste the code chunks there as we go.
